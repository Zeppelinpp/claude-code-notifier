...
<details open>
<summary><b>Codex (Plugin + Hook)</b></summary>

Register this repository as a Codex marketplace:

```bash
codex plugin marketplace add Zeppelinpp/CodePing
```
...
Codex currently loads runtime hooks from `~/.codex/hooks.json`. Install the Stop hook there:
        ...
        "hooks": [
          {
            ...
            "statusMessage": "Sending CodePing notification"
          }
        ]
      }
    ]
